...
begin
 ...
 S.Add('END');
 Screen.Cursor:=CrDefault;
 SaveDialog1.FileName:='Chuva Média Anual'+' - '+DM.SumarioUF.AsString+'.spr';
 If SaveDialog1.Execute then
...
begin
 ...
 S.Add('END');
 Screen.Cursor:=CrDefault;
 SaveDialog1.FileName:='Chuva Média Mensal '+MesCombo.Text+' - '+DM.SumarioUF.AsString+'.spr';
 If SaveDialog1.Execute then
  S.SaveToFile(SaveDialog1.FileName);
 S.Free;
 ProgressBar1.Position:=0;
...
begin
 ...
 S.Add('END');
 Screen.Cursor:=CrDefault;
 SaveDialog1.FileName:='Análise Frequencial '+DecilCombo.Text+' '+MesCombo2.Text+' '+QuinzCombo.Text+' - '+DM.SumarioUF.AsString+'.spr';
 If SaveDialog1.Execute then
  S.SaveToFile(ExtractFilePath(SaveDialog1.FileName)+'Análise Frequencial '+DecilCombo.Text+' '+MesCombo2.Text+' '+QuinzCombo.Text+' - '+DM.SumarioUF.AsString+'.spr');
 S.Free;
 ProgressBar1.Position:=0;
end;
